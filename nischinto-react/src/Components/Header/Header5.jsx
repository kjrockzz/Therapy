          ...
          <div className="st-top-header-in">
            <ul className="st-top-header-list">
              <li>
                ...
                <Link to="">info.Lettschat.com</Link>
              </li>
              <li>
                <svg
          ...
          <div className="st-main-header-in">
            <div className="st-main-header-left">
              <Link className="st-site-branding" to="">
               <div  className="st-top-header-btn st-type1 st-smooth-move" style={{fontSize:'50px', borderRadius:'10px'}}>LettsChat</div>
              </Link>
            </div>
            <div className="st-main-header-right">
              <div className="st-nav">
                <ul className={`st-nav-list st-onepage-nav ${mobileToggle ? "d-block" : "none"}`}>
                  ...
                  <li>
                    <ScrollLink to="pricing" spy={true} duration={500} onClick={() => setMobileToggle(false)} >Chat</ScrollLink>
                  </li>
                  <li>
                    <ScrollLink to="doctors" spy={true} duration={500} onClick={() => setMobileToggle(false)} >Therapist</ScrollLink>
                  </li>
